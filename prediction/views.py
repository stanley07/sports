...
def raw_predictions(request):
    ...
    df1 = df1.set_axis(['Match_Datetime', 'Country', 'League', 'Home_team', 'Away_team','Predicted_home_score', 'Predicted_away_score'], axis=1)
...
def football_upload(request):
    ...
    df1 = df1.reset_index()
    geeks_object = df1.to_html()
  
    return render(request, 'football_upload.html', {
    	'geeks_object': geeks_object
    	})
